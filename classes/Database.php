<?php
    ...
    class Database
    {
        ...
        function __construct() {
            $error = null;
            try {
                $dsn = '"mysql:host=localhost;dbname=sportvereniging;poort=3306;charset=utf8mb4"';
                $username = "sportvereniging1";
                $password = "123";
                $this->db = new PDO("mysql:host=localhost;dbname=sportvereniging", $username, $password, array(PDO::ATTR_PERSISTENT => true));
